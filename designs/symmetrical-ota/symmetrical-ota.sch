...
N 520 -200 620 -200 {lab=#net2}
N 480 -290 480 -230 {lab=#net2}
N 280 -320 480 -320 {lab=VDD}
N 280 -290 280 -180 {lab=#net3}
...
N 480 -260 570 -260 {lab=#net2}
N 570 -260 570 -200 {lab=#net2}
N 280 -210 380 -210 {lab=#net3}
N 380 -210 380 -150 {lab=#net3}
...
N 230 -320 240 -320 {lab=#net5}
N 520 -320 530 -320 {lab=VP}
N 80 -440 170 -440 {lab=VDD}
N 80 -120 280 -120 {lab=VSS}
N 170 -300 170 -280 {lab=IBIAS}
N 320 -150 620 -150 {lab=#net3}
N 820 -170 820 -120 {lab=VSS}
N 620 -200 780 -200 {lab=#net2}
N 660 -230 660 -180 {lab=#net4}
N 820 -380 820 -230 {lab=OUT}
N 660 -150 660 -120 {lab=VSS}
...
C {symbols/nfet_05v0.sym} 640 -150 0 0 {name=M9
L=0.75u
W=2.17u
nf=1
m=1
...
C {symbols/nfet_05v0.sym} 800 -200 0 0 {name=M10
L=0.75u
W=2.17u
nf=1
m=1
...
C {ipin.sym} 230 -320 2 1 {name=p2 lab=VN}
C {ipin.sym} 530 -320 0 1 {name=p3 lab=VP}
C {opin.sym} 820 -290 0 0 {name=p4 lab=OUT}
